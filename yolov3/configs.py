...
TRAIN_CLASSES               = "yolo/class_names.txt" # "carpk_data/class_names.txt" !!!
TRAIN_ANNOT_PATH            = "yolo/yolo_annotations_train.txt" # "carpk_data/yolo_annotations_train.txt" !!!
TRAIN_LOGDIR                = "log"
TRAIN_CHECKPOINTS_FOLDER    = "checkpoints"
TRAIN_MODEL_NAME            = f"{YOLO_TYPE}_custom"
TRAIN_LOAD_IMAGES_TO_RAM    = True # With True faster training, but need more RAM
TRAIN_BATCH_SIZE            = 4
TRAIN_INPUT_SIZE            = 608 # 416 !!!
TRAIN_DATA_AUG              = True
TRAIN_TRANSFER              = True
...
# TEST options
TEST_ANNOT_PATH             = "yolo/yolo_annotations_test.txt" # "carpk_data/yolo_annotations_test.txt" !!!
TEST_BATCH_SIZE             = 4
TEST_INPUT_SIZE             = 608 # 416 !!!
TEST_DATA_AUG               = False
